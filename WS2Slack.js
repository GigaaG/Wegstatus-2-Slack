...
(function() {
    ...
    function getData(){
        ...
        var bronElement =  document.querySelectorAll("body > div.container > div.panel.panel-primary > div > a")[3].innerText;

        if (bronElement.length > 1) {
            var bronURL = document.querySelectorAll("body > div.container > div.panel.panel-primary > div > a")[3].href
            var bronText = document.querySelectorAll("body > div.container > div.panel.panel-primary > div > a")[3].innerText;
        } else {
            var bronURL = null
            var bronText = null
        }
        ...
        var username = document.querySelector("#wsnavbar > ul.nav.navbar-nav.navbar-right > li > a").innerText;
